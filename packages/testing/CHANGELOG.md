...
- Fix Playwright route URL to use RegExp instead of Glob URL pattern ([#7036](https://github.com/clerk/javascript/pull/7036)) by [@anagstef](https://github.com/anagstef)
...
- Add Playwright testing helpers under unstable page-objects: `userAvatar.goTo()`, `userAvatar.waitForMounted()`, and `userAvatar.toBeVisible()` for <UserAvatar />. ([#6808](https://github.com/clerk/javascript/pull/6808)) by [@tmilewski](https://github.com/tmilewski)
...
- Improve reliability of checkout testing helpers. ([#6792](https://github.com/clerk/javascript/pull/6792)) by [@panteliselef](https://github.com/panteliselef)
...
- Introduce new helper to allow signing a user in via email address: ([#6545](https://github.com/clerk/javascript/pull/6545)) by [@brkalow](https://github.com/brkalow)
...
- Adding subscription details page object. ([#6333](https://github.com/clerk/javascript/pull/6333)) by [@panteliselef](https://github.com/panteliselef)
...
- Relax Cypress peer dependency to support v14 ([#6274](https://github.com/clerk/javascript/pull/6274)) by [@wobsoriano](https://github.com/wobsoriano)
...
- Bug fix: signIn() test helper was incorrectly throwing a validation error for valid test phone numbers ([#6250](https://github.com/clerk/javascript/pull/6250)) by [@calebjacob](https://github.com/calebjacob)
...
- Add API keys component testing helpers ([#6192](https://github.com/clerk/javascript/pull/6192)) by [@wobsoriano](https://github.com/wobsoriano)
...
- Add `checkout` and `pricingTable` page objects. ([#5776](https://github.com/clerk/javascript/pull/5776)) by [@dstaley](https://github.com/dstaley)
...
- Update `signInWithEmailAndInstantPassword` to wait for session by default. ([#5784](https://github.com/clerk/javascript/pull/5784)) by [@dstaley](https://github.com/dstaley)
...
- Update `setupClerk` to handle the explict setting of secret keys via `setupClerk({ secretKey: 'sk_test_***' })` ([#5561](https://github.com/clerk/javascript/pull/5561)) by [@tmilewski](https://github.com/tmilewski)

- Update `setupClerk` to enable skipping of the automatic loading of dot env files via `setupClerk({ dotenv: false })` ([#5561](https://github.com/clerk/javascript/pull/5561)) by [@tmilewski](https://github.com/tmilewski)
...
- Fix captcha triggering on Cypress tests ([#5182](https://github.com/clerk/javascript/pull/5182)) by [@anagstef](https://github.com/anagstef)
...
- Introduce helpers for Playwright E2E testing. ([#4006](https://github.com/clerk/javascript/pull/4006)) by [@anagstef](https://github.com/anagstef)
